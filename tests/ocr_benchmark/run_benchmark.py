...
from tests.ocr_benchmark.backends.tesseractocr_backend import TesseractBackend
...
def run() -> None:
    ...
    backend = TesseractBackend() # Change OCR model here
    ...
    output_file = OUTPUTS_DIR / "tesseract_result.json" #change to OCR ran in test
